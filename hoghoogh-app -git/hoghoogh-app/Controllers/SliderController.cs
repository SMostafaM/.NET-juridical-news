...
namespace hoghoogh_app.Controllers
{
    public class SliderController : Controller
    {
       ...
       /* public ActionResult Details()
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(Models.L_T_T_F n_Slider)
        {
            int C = Chek_cooke();
            if (C != 1)
            {
            ...
            try
            {
                ...
                int n = 0;
                foreach (var item in n_Slider.L_t_t_f)
                {
                    ...
                    else
                    {
                        ...
                        System.IO.File.Delete(o_home.slider.L_t_t_f[n].file_address);
                        item.file = null;
                        item.file_address = Path.Combine($@"\" + "Media", newFileName);
                    }
