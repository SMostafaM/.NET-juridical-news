...
{
    public class M1_4_lttfController : Controller
    {
        ///////////
        ...
        public ActionResult Create(Models.M1_4_lttf h_d , string state)
        {
            int C = Chek_cooke();
            if (C != 1)
            {
            ...
            try
            {
                h_d.L_t_t_f_1.L_t_t_f.RemoveAll(item => item.title == null && item.file == null && item.txt == null);
                h_d.L_t_t_f_2.L_t_t_f.RemoveAll(item => item.title == null && item.file == null && item.txt == null);
                h_d.L_t_t_f_3.L_t_t_f.RemoveAll(item => item.title == null && item.file == null && item.txt == null);
                h_d.L_t_t_f_4.L_t_t_f.RemoveAll(item => item.title == null && item.file == null && item.txt == null);
                



                foreach (var item in h_d.L_t_t_f_1.L_t_t_f)
                {
                    if (item.file != null)
                    {
                        //Getting FileName
                ...
                foreach (var item in h_d.L_t_t_f_2.L_t_t_f)
                {
                    if (item.file != null)
                    {
                        //Getting FileName
                ...
                foreach (var item in h_d.L_t_t_f_3.L_t_t_f)
                {
                    if (item.file != null)
                    {
                        //Getting FileName
                ...
                foreach (var item in h_d.L_t_t_f_4.L_t_t_f)
                {
                    if (item.file != null)
                    {
                        //Getting FileName
                ...
                if (state == "1")
                {
                    try
                    {
                        if (L_Home.M1_L_4 != null)
                        {
                            if (L_Home.M1_L_4.L_t_t_f_1 != null)
                            {
                                //h_d.L_t_t_f_1.L_t_t_f.AddRange(L_Home.M1_L_4.L_t_t_f_1.L_t_t_f);
                                L_Home.M1_L_4.L_t_t_f_1.L_t_t_f.AddRange(h_d.L_t_t_f_1.L_t_t_f);
                            }
                            if (L_Home.M1_L_4.L_t_t_f_2 != null)
                            {
                                //h_d.L_t_t_f_2.L_t_t_f.AddRange(L_Home.M1_L_4.L_t_t_f_2.L_t_t_f);
                                L_Home.M1_L_4.L_t_t_f_2.L_t_t_f.AddRange(h_d.L_t_t_f_2.L_t_t_f);
                            }
                            if (L_Home.M1_L_4.L_t_t_f_3 != null)
                            {
                                //h_d.L_t_t_f_3.L_t_t_f.AddRange(L_Home.M1_L_4.L_t_t_f_3.L_t_t_f);
                                L_Home.M1_L_4.L_t_t_f_3.L_t_t_f.AddRange(h_d.L_t_t_f_3.L_t_t_f);
                            }
                            if (L_Home.M1_L_4.L_t_t_f_4 != null)
                            {
                                //h_d.L_t_t_f_4.L_t_t_f.AddRange(L_Home.M1_L_4.L_t_t_f_4.L_t_t_f);
                                L_Home.M1_L_4.L_t_t_f_4.L_t_t_f.AddRange(h_d.L_t_t_f_4.L_t_t_f);
                            }
                        }
                    }
                    catch
                ...
                string json_user = JsonConvert.SerializeObject(L_Home);
                request.AddHeader("Authorization", "6ee5531a624dbf80b4454b9f9db0eb7f62a314c8");
                //user in header
        ...
        public ActionResult Edit()
        {
            ...
            Models.Home L_Home = new Models.Home();
            Models.M1_4_lttf M1 = new Models.M1_4_lttf();
            try
            {
                RestClient client = new RestClient("https://localhost:44312/api/Home_API/home_data_all");
                client.Timeout = -1;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(Models.M1_4_lttf n_M1)
        {
            int C = Chek_cooke();
            if (C != 1)
            {
            ...
            try
            {
                if (n_M1.L_t_t_f_1.L_t_t_f != null) { n_M1.L_t_t_f_1.L_t_t_f.RemoveAll(item => item.title == null && item.file == null && item.txt == null); }
                else
                {
                    List<Models.T_T_F> lt= new List<Models.T_T_F>();
                    n_M1.L_t_t_f_1.L_t_t_f = lt;
                }
                if (n_M1.L_t_t_f_2.L_t_t_f != null) { n_M1.L_t_t_f_2.L_t_t_f.RemoveAll(item => item.title == null && item.file == null && item.txt == null); }
                else
                {
                    List<Models.T_T_F> lt = new List<Models.T_T_F>();
                    n_M1.L_t_t_f_2.L_t_t_f = lt;
                }
                if (n_M1.L_t_t_f_3.L_t_t_f != null) { n_M1.L_t_t_f_3.L_t_t_f.RemoveAll(item => item.title == null && item.file == null && item.txt == null); }
                else
                {
                    List<Models.T_T_F> lt = new List<Models.T_T_F>();
                    n_M1.L_t_t_f_3.L_t_t_f = lt;
                }
                if (n_M1.L_t_t_f_4.L_t_t_f != null) { n_M1.L_t_t_f_4.L_t_t_f.RemoveAll(item => item.title == null && item.file == null && item.txt == null); }
                else
                {
                    List<Models.T_T_F> lt = new List<Models.T_T_F>();
                    n_M1.L_t_t_f_4.L_t_t_f = lt;
                }
                ...
                int n = 0;
                foreach (var item in n_M1.L_t_t_f_1.L_t_t_f)
                {
                    ...
                    if (item.file == null)
                    {
                        ...
                        {*/
                            item.file_address = o_home.M1_L_4.L_t_t_f_1.L_t_t_f[n].file_address;
                        /*}*/
                    }
                    else
                    {
                        ...
                        if (o_home.M1_L_4.L_t_t_f_1.L_t_t_f[n].file_address != null)
                            System.IO.File.Delete(Path.Combine(Directory.GetCurrentDirectory(), "wwwroot") + $@"/{o_home.M1_L_4.L_t_t_f_1.L_t_t_f[n].file_address}");
                        item.file = null;
                        item.file_address= Path.Combine($@"/" + "Media", newFileName);
                    }
                ...
                n = 0;
                foreach (var item in n_M1.L_t_t_f_2.L_t_t_f)
                {
                    ...
                    if (item.file == null)
                    {
                        /*if (n < o_home.masadigh_EN_main.Count)
                        {*/
                        item.file_address = o_home.M1_L_4.L_t_t_f_2.L_t_t_f[n].file_address;
                        /*}*/
                    }
                    else
                    {
                        ...
                        if (o_home.M1_L_4.L_t_t_f_2.L_t_t_f[n].file_address != null)
                            System.IO.File.Delete(Path.Combine(Directory.GetCurrentDirectory(), "wwwroot") + $@"/{o_home.M1_L_4.L_t_t_f_2.L_t_t_f[n].file_address}");
                        item.file = null;
                        item.file_address = Path.Combine($@"/" + "Media", newFileName);
                    }
                ...
                n = 0;
                foreach (var item in n_M1.L_t_t_f_3.L_t_t_f)
                {
                    ...
                    if (item.file == null)
                    {
                        /*if (n < o_home.masadigh_EN_main.Count)
                        {*/
                        item.file_address = o_home.M1_L_4.L_t_t_f_3.L_t_t_f[n].file_address;
                        /*}*/
                    }
                    else
                    {
                        ...
                        if (o_home.M1_L_4.L_t_t_f_3.L_t_t_f[n].file_address != null)
                            System.IO.File.Delete(Path.Combine(Directory.GetCurrentDirectory(), "wwwroot") + $@"/{o_home.M1_L_4.L_t_t_f_3.L_t_t_f[n].file_address}");
                        item.file = null;
                        item.file_address = Path.Combine($@"/" + "Media", newFileName);
                    }
                ...
                n = 0;
                foreach (var item in n_M1.L_t_t_f_4.L_t_t_f)
                {
                    ...
                    if (item.file == null)
                    {
                        /*if (n < o_home.masadigh_EN_main.Count)
                        {*/
                        item.file_address = o_home.M1_L_4.L_t_t_f_4.L_t_t_f[n].file_address;
                        /*}*/
                    }
                    else
                    {
                        ...
                        if (o_home.M1_L_4.L_t_t_f_4.L_t_t_f[n].file_address != null)
                            System.IO.File.Delete(Path.Combine(Directory.GetCurrentDirectory(), "wwwroot") + $@"/{o_home.M1_L_4.L_t_t_f_4.L_t_t_f[n].file_address}");
                        item.file = null;
                        item.file_address = Path.Combine($@"/" + "Media", newFileName);
                    }
