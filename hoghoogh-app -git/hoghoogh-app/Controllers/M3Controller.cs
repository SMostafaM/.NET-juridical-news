...
/*        public ActionResult Details()
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(Models.L_T_T_F n_M3)
        {
            int C = Chek_cooke();
            if (C != 1)
            {
            ...
            try
            {
                ...
                int n = 0;
                foreach (var item in n_M3.L_t_t_f)
                {
                    ...
                    else
                    {
                        ...
                        System.IO.File.Delete(o_home.M3.L_t_t_f[n].file_address);
                        item.file = null;
                        item.file_address = Path.Combine($@"\" + "Media", newFileName);
                    }
